...
\todo{Make a figure showing a typical CoAP example}

Figure \todo{X} shows a typical CoAP message, in which only 13 bytes are needed to format this message, allowing the rest of the frame for payload.
